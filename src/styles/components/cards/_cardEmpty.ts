import { _borderRadius, _colors, _dimensions, _footer } from "@src/styles/_global.styles";
import { StyleSheet } from "react-native";

const containerHeight = _dimensions.fullHeight - _footer.height - 10
const headerHeight = 150

export const cardEmptyStyles = StyleSheet.create({
  container: {
    width: (_dimensions.fullWidth - 20),
    marginLeft: 'auto',
    marginRight: 'auto',
    marginTop: 20,
